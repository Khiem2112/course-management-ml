...
"border: none")
        ...
        self.header_student.setStyleSheet("border: none;\n"
"color: black\n"
"")
        ...
        self.course_student_previous.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/Icons/images/icons/Course/le-Photoroom.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.course_student_previous.setIcon(icon6)
        ...
        self.course_student_next.setIcon(icon7)
