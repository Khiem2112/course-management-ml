...
"")
        ...
        self.analysis_table.setMinimumSize(QtCore.QSize(0, 0))
        self.analysis_table.setStyleSheet("color: black")
        self.analysis_table.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        ...
        self.pie_chart_widget = QtWidgets.QWidget(parent=self.frame_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"    border-radius: 12px;          /* bo tròn góc */")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "ClusterID"))
        item = self.analysis_table.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Cluster Name"))
