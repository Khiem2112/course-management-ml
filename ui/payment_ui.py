# Form implementation generated from reading ui file 'C:\Users\phamn\Documents\ML_final\ui\payment.ui'
#
...
"")
        ...
        self.payment_create = QtWidgets.QPushButton(parent=self.frame_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.payment_create.sizePolicy().hasHeightForWidth())
        self.payment_create.setSizePolicy(sizePolicy)
        self.payment_create.setMinimumSize(QtCore.QSize(82, 30))
        self.payment_create.setObjectName("payment_create")
        self.horizontalLayout_4.addWidget(self.payment_create)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.payment_create.setText(_translate("MainWindow", "+ Create"))
