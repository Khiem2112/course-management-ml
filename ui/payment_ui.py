...
"")
        ...
        self.payment_search_comboBox = QtWidgets.QComboBox(parent=self.search)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.payment_search_comboBox.sizePolicy().hasHeightForWidth())
        self.payment_search_comboBox.setSizePolicy(sizePolicy)
        self.payment_search_comboBox.setMinimumSize(QtCore.QSize(165, 31))
        self.payment_search_comboBox.setObjectName("payment_search_comboBox")
        self.payment_search_comboBox.addItem("")
        self.payment_search_comboBox.addItem("")
        self.payment_search_comboBox.addItem("")
        self.payment_search_comboBox.addItem("")
        self.payment_search_comboBox.addItem("")
        self.payment_search_comboBox.addItem("")
        self.payment_search_comboBox.addItem("")
        self.horizontalLayout_3.addWidget(self.payment_search_comboBox)
        self.payment_search_lineEdit = QtWidgets.QLineEdit(parent=self.search)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.payment_search_lineEdit.sizePolicy().hasHeightForWidth())
        self.payment_search_lineEdit.setSizePolicy(sizePolicy)
        self.payment_search_lineEdit.setMinimumSize(QtCore.QSize(260, 31))
        self.payment_search_lineEdit.setObjectName("payment_search_lineEdit")
        self.horizontalLayout_3.addWidget(self.payment_search_lineEdit)
        ...
        self.payment_filter = QtWidgets.QPushButton(parent=self.frame_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.payment_filter.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.payment_search_comboBox.setItemText(0, _translate("MainWindow", "ID Invoice"))
        self.payment_search_comboBox.setItemText(1, _translate("MainWindow", "ID Student"))
        self.payment_search_comboBox.setItemText(2, _translate("MainWindow", "Code Module"))
        self.payment_search_comboBox.setItemText(3, _translate("MainWindow", "Code Presentation"))
        self.payment_search_comboBox.setItemText(4, _translate("MainWindow", "Date"))
        self.payment_search_comboBox.setItemText(5, _translate("MainWindow", "Amount"))
        self.payment_search_comboBox.setItemText(6, _translate("MainWindow", "Status"))
        self.payment_search_lineEdit.setPlaceholderText(_translate("MainWindow", "Search"))
        self.payment_filter.setText(_translate("MainWindow", "Filter"))
